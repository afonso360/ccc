...
MD5 utility. Darwin runs may use the tracked OpenSSL-backed `md5sum-darwin`
adapter, including the checked-stdin mode required by the official suite. Both
hash tools are probed before any download or build. Pass an already-downloaded
