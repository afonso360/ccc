...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Implemented               | `noreturn`, `__noreturn__`, record-specifier `packed` and `__packed__`, `mode`, `__mode__`, `aligned`, `__aligned__`, `weak`, `__weak__`, `visibility`; their control-flow, type, layout, binding, or visibility effects are retained through the applicable compiler stages. Other `packed` placements receive `CCC2432` rather than being ignored.              |
| Behavior-compatible no-op | `nothrow`, `__nothrow__`, `pure`, `__pure__`, `const`, `__const__`, `malloc`, `__malloc__`, `format`, `__format__`, `nonnull`, `__nonnull__`, `warn_unused_result`, `__warn_unused_result__`, `unused`, `__unused__`, `deprecated`, `__deprecated__`, `noinline`, `__noinline__`, `always_inline`, `__always_inline__`; omitting their optimization or diagnostic effects does not change generated C behavior |
