...
| [C11 and GNU semantics](core-c11-and-gnu-semantics.md) | Activation contract for selected C11 constructs, GNU expressions, wide integers, builtins, and assembly |
