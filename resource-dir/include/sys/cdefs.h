 ...
 * CCC records always_inline but does not yet honor it during code generation,
 * so the SDK's GCC-compatible extern-inline branch would otherwise publish one
 * definition per translation unit.  Use the SDK's documented static-inline
 * fallback: it preserves each header implementation without claiming
